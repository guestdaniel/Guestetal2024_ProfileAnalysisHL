...
experiment = ProfileAnalysis_PFTemplateObserver_HearingImpaired()
...
figs = map(sims_complete) do sim
    ...
    desc = typeof(sim.model) == AuditoryNerveZBC2014 ? sim.model.audiogram.desc : sim.model.frontend.audiogram.desc
...
save("\\home\\daniel\\cl_fig\\pahi\\2023-07-06_diagnosis_hi.png", fig)