...
fitted_data = @chain df begin
    ...
    groupby([:increment, :n_comp, :freq, :subj, :rove, :age, :sex, :hl, :hl_group, :pta_all, :pta_3, :pta_4, :pta_jama, :pta_upper, :sl, :condition, :include])
    @combine(
        :pcorr = mean(:pcorr)
    )
    # Fit thresholds to data
    groupby([:n_comp, :freq, :subj, :rove, :age, :sex, :hl, :hl_group, :pta_all, :pta_3, :pta_4, :pta_upper, :sl, :pta_jama, :condition, :include])
    ...
    @select(:n_comp, :freq, :subj, :rove, :threshold, :slope, :age, :hl_group, :sex, :hl, :pta_all, :pta_3, :pta_4, :pta_upper, :pta_jama, :sl, :condition, :include)
end
